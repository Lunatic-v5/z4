...
echo -e "                 └──────────────────────────────────┘"
echo -e "${HG} ┌────────────────────────────────────────────────────────────┐${NC}"
echo -e "${HG} │ ${HB} 01📨${NC} ${HW}ssh / Libev      $NC  ${HB}11${NC} ${HW}Domain Options      $NC"
echo -e "${HG} │ ${HB} 02📨${NC} ${HW}vmess / Xray     $NC  ${HB}12${NC} ${HW}Change Banner       $NC"
echo -e "${HG} │ ${HB} 03📨${NC} ${HW}vless / Xray     $NC  ${HB}13${NC} ${HW}Restart / Service   $NC"
echo -e "${HG} │ ${HB} 04📨${NC} ${HW}trojan Libev     $NC  ${HB}14${NC} ${HW}Reboot Vps          $NC"
echo -e "${HG} │ ${HB} 05📨${NC} ${HW}ShDw Sck / Ss    $NC  ${HB}15${NC} ${HW}Installing Udp      $NC"
echo -e "${HG} │ ${HB} 06📨${NC} ${HW}Running/serV     $NC  ${HB}16${NC} ${HW}Sett Manager        $NC"
echo -e "${HG} │ ${HB} 07📨${NC} ${HW}Backup MnaGer    $NC  ${HB}17${NC} ${HW}Up Version script   $NC"
echo -e "${HG} │ ${HB} 08📨${NC} ${HW}Inf Port / Vpn   $NC  ${HB}18${NC} ${HW}Clear Exp Account   $NC"
echo -e "${HG} │ ${HB} 09📨${NC} ${HW}MoonT Vps Info   $NC  ${HB}19${NC} ${HW}Clear Log / ALL     $NC"
echo -e "${HG} │ ${HB} 10📨${NC} ${HW}Spedtest LuA     $NC  ${HB}20${NC} ${HW}Bot manager / LiBev $NC"
echo -e "${HG} └────────────────────────────────────────────────────────────┘${NC}"
echo -e "${GR}                                4.00.7 ${NC}"
